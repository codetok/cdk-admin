...
@Injectable()
export class AllFeaturesTableService {
    allFeaturesTablehtmlsource: string = `<div class="example-header" [style.display]="selection.isEmpty() ? '' : 'none'">
...
`.trim();
  allFeaturesTabletssource:string = `import {Component, ElementRef, ViewChild} from '@angular/core';
import {DataSource} from '@angular/cdk/collections';
import {MatPaginator, MatSort} from '@angular/material';
...
` 
  allFeaturesTablecsssource:string = `/* Structure */
.example-container {
  display: flex;
