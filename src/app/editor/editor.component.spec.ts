...
describe('Basic QuillEditorComponent', () => {
  ...
  beforeEach(() => {
    ...
    this.fixture = TestBed.createComponent(EditorComponent) as ComponentFixture<EditorComponent>;
  });
...
describe('Advanced QuillEditorComponent', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [EditorComponent, TestComponent, TestToolbarComponent],
      imports: [FormsModule]
    }).compileComponents();
